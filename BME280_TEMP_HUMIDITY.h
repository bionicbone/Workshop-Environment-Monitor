...
// BME280_TEMP_HUMIDITY.h

#ifndef _BME280_TEMP_HUMIDITY_h
#define _BME280_TEMP_HUMIDITY_h
...
extern HASensorNumber ha_bme280_temp;
extern HASensorNumber ha_bme280_humidity;
extern HASensorNumber ha_bme280_pressure;

extern bool bme280Detected;            // true = sensor initialised at boot (optional-sensor gate)
extern unsigned long lastBME280OkMs;   // millis() of last good read (staleness)
