...
#ifndef _SGP30_SENSOR_h
#define _SGP30_SENSOR_h
...
extern bool sgp30BaselineRestored;    // true = a valid baseline was loaded at boot (warmup gate)

void setupSGP30_VOC();
void updateSGP30_VOC();
void saveSGP30Baseline();
void restoreSGP30Baseline();
void resetSGP30Baseline();						// clears stored NVS baseline (long-press triggered, see Buzzer.cpp)
uint16_t getTVOC();
